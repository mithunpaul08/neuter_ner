...
- status as of 29th april
 ...
 - status of sstagging for each dataset
   - **fever-train**: 
        ...
        - latest status:count  is 122347/238,394 files done
    - **fever-dev**: 
    ...
    - **fnc-train**
        - have started a run on **amy** from **tmux 0** 
        ...
        - latest status:count is 669/81808
    ...
    - **fnc-dev**   
       ...
       - latest status: 687/18136 files are done.
